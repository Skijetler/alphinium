...
func ID(id uint64) predicate.Subcategory {
...
func IDEQ(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func IDIn(ids ...uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func IDGTE(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func IDLT(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func IDLTE(id uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func CategoryID(v uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func CategoryIDEQ(v uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCategoryID), v))
	})
}
...
func CategoryIDNEQ(v uint64) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
...
func CategoryIDIn(vs ...uint64) predicate.Subcategory {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CategoryIDNotIn(vs ...uint64) predicate.Subcategory {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HasThreads() predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ThreadsTable, FieldID),
...
func HasThreadsWith(preds ...predicate.Thread) predicate.Subcategory {
	return predicate.Subcategory(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
