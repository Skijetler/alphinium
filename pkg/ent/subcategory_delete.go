...
func (sd *SubcategoryDelete) Where(ps ...predicate.Subcategory) *SubcategoryDelete {
	sd.mutation.Where(ps...)
	return sd
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (sd *SubcategoryDelete) Exec(ctx context.Context) (int, error) {
	var (
		err      error
		affected int
	)
...
func (sd *SubcategoryDelete) ExecX(ctx context.Context) int {
	n, err := sd.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (sd *SubcategoryDelete) sqlExec(ctx context.Context) (int, error) {
...
type SubcategoryDeleteOne struct {
	sd *SubcategoryDelete
}

// Exec executes the deletion query.
func (sdo *SubcategoryDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (sdo *SubcategoryDeleteOne) ExecX(ctx context.Context) {
	sdo.sd.ExecX(ctx)
}
