...
func RegistrationDate(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRegistrationDate), v))
	})
}
...
func RegistrationDateEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRegistrationDate), v))
	})
}
...
func RegistrationDateNEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldRegistrationDate), v))
	})
}

// RegistrationDateIn applies the In predicate on the "registration_date" field.
func RegistrationDateIn(vs ...time.Time) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.In(s.C(FieldRegistrationDate), v...))
	})
}

// RegistrationDateNotIn applies the NotIn predicate on the "registration_date" field.
func RegistrationDateNotIn(vs ...time.Time) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NotIn(s.C(FieldRegistrationDate), v...))
	})
}

// RegistrationDateGT applies the GT predicate on the "registration_date" field.
func RegistrationDateGT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldRegistrationDate), v))
	})
}

// RegistrationDateGTE applies the GTE predicate on the "registration_date" field.
func RegistrationDateGTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldRegistrationDate), v))
	})
}

// RegistrationDateLT applies the LT predicate on the "registration_date" field.
func RegistrationDateLT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldRegistrationDate), v))
	})
}

// RegistrationDateLTE applies the LTE predicate on the "registration_date" field.
func RegistrationDateLTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldRegistrationDate), v))
	})
}
...
func HasMetadataWith(preds ...predicate.UserMetadata) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
