...
func (uc *UserCreate) SetRegistrationDate(t time.Time) *UserCreate {
	uc.mutation.SetRegistrationDate(t)
	return uc
}
...
func (uc *UserCreate) SetMetadataID(id uint64) *UserCreate {
...
func (uc *UserCreate) SetNillableMetadataID(id *uint64) *UserCreate {
	if id != nil {
...
func (uc *UserCreate) AddAttachmentIDs(ids ...uint64) *UserCreate {
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.RegistrationDate(); !ok {
		return &ValidationError{Name: "registration_date", err: errors.New(`ent: missing required field "User.registration_date"`)}
	}
	if _, ok := uc.mutation.Disabled(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.RegistrationDate(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: user.FieldRegistrationDate,
		})
